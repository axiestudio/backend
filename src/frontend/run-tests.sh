...
# Start the backend
AXIESTUDIO_DATABASE_URL=sqlite:///./temp AXIESTUDIO_AUTO_LOGIN=True poetry run axiestudio run --backend-only --port 7860 --host 0.0.0.0 --no-open-browser > /dev/null 2>&1 &
