    ...
    <>
      <Form.Field name="name">
        <div className="edit-flow-arrangement">
          ...
          {isMaxLength && (
            <span className="edit-flow-span">Teckengräns nådd</span>
          )}
          {isMinLength && (
            <span className="edit-flow-span">
              Minst {minLength} tecken krävs
            </span>
          )}
          {isInvalidName && (
            <span className="edit-flow-span">Flödesnamnet finns redan</span>
          )}
        </div>
        {setName ? (
        ...
        >
          Flödesnamnet finns redan
        </Form.Message>
      </Form.Field>
      <Form.Field name="description">
        <div className="edit-flow-arrangement mt-3">
          <Form.Label className="text-mmd font-medium">
            Beskrivning{setDescription ? "" : ":"}
          </Form.Label>
        ...
        {setDescription ? (
          ...
          >
            {description === "" ? "Ingen beskrivning" : description}
          </div>
        )}
        <Form.Message match="valueMissing" className="field-invalid">
