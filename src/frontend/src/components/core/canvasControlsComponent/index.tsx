  ...
  return (
    ...
    >
      ...
      <CustomControlButton
        ...
        tooltipText={isInteractive ? "Lås" : "Lås Upp"}
      ...
      <CustomControlButton
        ...
        tooltipText={
          helperLineEnabled ? "Dölj Hjälplinjer" : "Visa Hjälplinjer"
        }
