    ...
    <div className={cn("absolute bottom-3 left-6")}>
      <div className="flex items-center gap-3">
        {addRow && !tableOptions?.block_add && (
          <div>
            <ShadTooltip content={"Lägg till en ny rad"}>
        ...
        {duplicateRow && (
          <div>
            <ShadTooltip
              content={
                !hasSelection ? (
                  <span>Välj objekt att duplicera</span>
                ) : (
                  <span>Duplicera valda objekt</span>
                )
              }
            >
              <Button
        ...
        {deleteRow && (
          <div>
            <ShadTooltip
              content={
                !hasSelection ? (
                  <span>Välj objekt att ta bort</span>
                ) : (
                  <span>Ta bort valda objekt</span>
                )
              }
            >
              <Button
        ...
        <div>
          <ShadTooltip content="Återställ Kolumner">
            <Button
        ...
        {paginationInfo && (
          <div className="ml-2 text-xs text-muted-foreground">
            <ShadTooltip content="Sidnumreringsinformation">
