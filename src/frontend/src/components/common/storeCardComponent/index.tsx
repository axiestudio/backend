...
export default function StoreCardComponent({
  ...
  const name = data.is_component ? "Komponent" : "Flöde";
      ...
      mutate(
        { componentId: data.id },
        {
          ...
          onError: (error) => {
            ...
            console.error(error);
            setErrorData({
              title: `Fel vid gillande av ${name}.`,
            ...
            <div>
              <CardTitle className="flex w-full items-start justify-between gap-3 text-xl">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {!data.is_component && (
                    <ShadTooltip content="Komponenter">
                      <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  ...
                  <ShadTooltip content="Gillningar">
                    <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  ...
                  <ShadTooltip content="Nedladdningar">
                    <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
            ...
            <div className="flex gap-2">
              {data.user_created && data.user_created.username && (
                <span className="text-sm text-primary">
                  av <b>{data.user_created.username}</b>
          ...
          <div className="z-50 flex w-full items-center justify-between gap-2">
            <div className="flex w-full flex-wrap items-end justify-end gap-2">
              <div className="flex gap-0.5">
                <ShadTooltip
                  content={authorized ? "Gilla" : "Vänligen granska din API-nyckel."}
                >
                  <Button
                    disabled={isPending}
                    variant="ghost"
                ...
                <ShadTooltip
                  content={
                    authorized
                      ? "Installera Lokalt"
                      : "Vänligen granska din API-nyckel."
                  }
                >
                  <Button
                    disabled={loading}
