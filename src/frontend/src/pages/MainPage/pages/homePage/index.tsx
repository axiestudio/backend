...
const HomePage = ({ type }: { type: "flows" | "components" | "mcp" }) => {
  ...
  return (
    <CardsWrapComponent
      ...
      dragMessage={`Släpp dina ${isEmptyFolder ? "flöden eller komponenter" : flowType === "flows" ? "flöden" : flowType === "components" ? "komponenter" : flowType} här`}
    >
      <div
      ...
      >
        <div className="flex h-full w-full flex-col 3xl:container">
          {ENABLE_DATASTAX_AXIESTUDIO && <CustomBanner />}
                ...
                <div className="flex h-full flex-col">
                  {isLoading ? (
                    ...
                    <div className="pt-24 text-center text-sm text-secondary-foreground">
                      ...
                      <a
                        href="https://docs.axiestudio.org/components-custom-components"
                        target="_blank"
                        rel="noreferrer"
                        className="underline"
                      >
