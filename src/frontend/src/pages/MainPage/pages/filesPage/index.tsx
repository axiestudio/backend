...
export const FilesPage = () => {
  ...
  const UploadButtonComponent = useMemo(() => {
    return (
      <ShadTooltip content="Ladda upp fil" side="bottom">
        <Button
            ...
            <div className="flex h-full flex-col py-4">
              {!files || !Array.isArray(files) ? (
                ...
                <CardsWrapComponent
                  ...
                  dragMessage="Släpp filer för att ladda upp"
                >
                  <div className="flex h-full w-full flex-col items-center justify-center gap-8 pb-8">
                    <div className="flex flex-col items-center gap-2">
                      <h3 className="text-2xl font-semibold">Inga filer</h3>
                      <p className="text-lg text-secondary-foreground">
                        Ladda upp filer eller importera från ditt föredragna moln.
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                      {UploadButtonComponent}
