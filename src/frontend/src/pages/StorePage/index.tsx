          ...
          setErrorData({
            ...
            list: [
              err?.response?.data?.detail ??
                "Det uppstod ett fel vid hämtning av komponenter",
            ],
          });
        }
      });
        ...
        <div className="flex w-full flex-col gap-4 p-0">
          <div className="flex items-end gap-4">
            ...
            <div className="ml-4 flex w-full gap-2 border-b border-border">
              ...
              <ShadTooltip content="Kommer Snart">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <SelectTrigger className="mr-4 w-[160px] flex-shrink-0">
                <SelectValue placeholder="Filtervärden" />
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
          ...
          <div className="flex items-end justify-between">
            <span className="px-0.5 text-sm text-muted-foreground">
              {(!loading || searchData.length !== 0) && (
                <>
                  {totalRowsCount} {totalRowsCount !== 1 ? "resultat" : "resultat"}
                </>
              )}
            </span>
            ...
            >
              <SelectTrigger data-testid="select-order-store">
                <SelectValue placeholder="Populära" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="Popular">Populära</SelectItem>
                ...
                <div className="flex w-full flex-col gap-4">
                  <div className="grid w-full gap-4">
                    {selectFilter != "all" ? (
                      <>
                        Du har inte{" "}
                        {selectFilter === "createdbyme" ? "skapat" : "gillat"}{" "}
                        något med de valda filtren än.
                      </>
                    ) : (
                      <>
                        Det finns inga{" "}
                        {tabActive == "Flows" ? "Flöden" : "Komponenter"} med de
                        valda filtren.
                      </>
                    )}
                  </div>
