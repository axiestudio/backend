...
const ToolbarModals = memo(
  ({
    ...
    const handleConfirm = () => {
      ...
      setSuccessData({ title: `${data.id} framgångsrikt ersatt!` });
    ...
    const handleCancel = () => {
      ...
      setSuccessData({ title: "Ny komponent framgångsrikt sparad!" });
      setShowOverrideModal(false);
    };
        ...
        {showOverrideModal && (
          ...
          >
            <ConfirmationModal.Content>
              <span>
                Det verkar som att {data.node?.display_name} redan finns. Vill du
                ersätta den med den nuvarande eller skapa en ny?
              </span>
            </ConfirmationModal.Content>
          </ConfirmationModal>
        )}
