...
const NodeToolbarComponent = memo(
  ({
    ...
    const handleMinimize = useCallback(() => {
      ...
      setNoticeData({
        title:
          "Minimering endast tillgänglig för komponenter med ett handtag eller färre.",
      });
    ...
    const handleCodeModal = useCallback(() => {
      if (!hasCode) {
        setNoticeData({ title: `Du kan inte komma åt ${data.id} kod` });
      }
    ...
    const saveComponent = useCallback(() => {
      ...
      setSuccessData({ title: `${data.id} sparat framgångsrikt` });
    ...
    const openDocs = useCallback(() => {
      ...
      setNoticeData({
        title: `${data.id} dokumentation är inte tillgänglig för tillfället.`,
      });
          ...
          {hasToolMode && (
            ...
            >
              ...
              >
                ...
                />
                <span className="text-mmd font-medium">Verktygsläge</span>
                <ToggleShadComponent
                  value={toolMode}
                  editNode={false}
                  handleOnNewValue={() => {
          ...
          <div className="toolbar-wrapper">
            ...
            >
              <SelectTrigger className="w-62">
                <ShadTooltip content="Visa mer" side="top">
                ...
                {isOutdated && (
                  <SelectItem value={"update"}>
                    <ToolbarSelectItem
                      ...
                      value={isUserEdited ? "Återställ" : "Uppdatera"}
                ...
                {(isMinimal || !showNode) && (
                  ...
                  >
                    <ToolbarSelectItem
                      ...
                      value={showNode ? "Minimera" : "Expandera"}
