        ...
        <div className="admin-page-panel flex h-full flex-col pb-8">
          ...
          <div className="flex w-full justify-between px-4">
            ...
            <div>
              <UserManagementModal
                title="Ny användare"
                titleHeader={"Lägg till en ny användare"}
                cancelText="Avbryt"
                confirmationText="Spara"
                icon={"UserPlus2"}
                ...
                asChild
              >
                <Button variant="primary">Ny användare</Button>
              </UserManagementModal>
            </div>
          </div>
          {isPending || isIdle ? (
                ...
                <Table className={"table-fixed outline-1"}>
                  ...
                  >
                    <TableRow>
                      ...
                      <TableHead className="h-10">Användarnamn</TableHead>
                      <TableHead className="h-10">E-post</TableHead>
                      <TableHead className="h-10">Aktiv</TableHead>
                      <TableHead className="h-10">Superanvändare</TableHead>
                      <TableHead className="h-10">Skapad</TableHead>
                      <TableHead className="h-10">Uppdaterad</TableHead>
                        ...
                        <TableRow key={index}>
                          ...
                          <TableCell className="relative left-1 truncate py-2 text-align-last-left">
                            <ConfirmationModal
                              ...
                              modalContentTitle="Uppmärksamhet!"
                              cancelText="Avbryt"
                            ...
                            >
                              <ConfirmationModal.Content>
                                <span>
                                  Är du helt säker på ändringarna
                                  du gör för denna användare?
                                </span>
                              </ConfirmationModal.Content>
                          ...
                          <TableCell className="flex w-[100px] py-2 text-right">
                            <div className="flex">
                              ...
                              >
                                <ShadTooltip content="Redigera" side="top">
                                  <IconComponent
                                    name="Pencil"
