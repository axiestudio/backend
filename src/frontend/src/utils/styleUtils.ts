...
export const SIDEBAR_CATEGORIES = [
  { display_name: "Sparade", name: "saved_components", icon: "GradientSave" },
  { display_name: "Inmatning / Utmatning", name: "input_output", icon: "Cable" },
  { display_name: "Agenter", name: "agents", icon: "Bot" },
  { display_name: "Modeller", name: "models", icon: "BrainCog" },
  { display_name: "Data", name: "data", icon: "Database" },
  { display_name: "Vektorlager", name: "vectorstores", icon: "Layers" },
  { display_name: "Bearbetning", name: "processing", icon: "ListFilter" },
  { display_name: "Logik", name: "logic", icon: "ArrowRightLeft" },
  { display_name: "Hjälpare", name: "helpers", icon: "Wand2" },
  { display_name: "Inmatningar", name: "inputs", icon: "Download" },
  { display_name: "Utmatningar", name: "outputs", icon: "Upload" },
