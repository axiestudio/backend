    ...
    <>
      ...
      >
        ...
        >
          <IconComponent
            ...
            aria-hidden="true"
          />
          <span className="pl-2">API-åtkomst</span>
          {nodes.length > 0 && (
      ...
      >
        <BaseModal.Header>
          ...
          <span className="pl-2">Inmatningsschema</span>
        </BaseModal.Header>
        <BaseModal.Content overflowHidden className="flex flex-col gap-4">
          ...
          <div className="flex flex-1 flex-col gap-2 overflow-hidden">
            <div className="flex flex-col gap-1">
              <span className="shrink-0 text-sm font-medium">Exponera API</span>
              <span className="text-mmd text-muted-foreground">
                Välj vilka komponentfält som ska exponeras som inmatningar i detta flödes
                API-schema.
              </span>
            </div>
