  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        title={isLocal ? "Ta bort Fil" : "Avlägsna Fil"}
        titleHeader={`Är du säker på att du vill ${isLocal ? "ta bort" : "avlägsna"} "${file.name}"?`}
        cancelText="Avbryt"
        size="x-small"
        confirmationText={isLocal ? "Ta bort" : "Avlägsna"}
