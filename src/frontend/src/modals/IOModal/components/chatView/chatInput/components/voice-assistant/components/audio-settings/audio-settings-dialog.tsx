              ...
              <div className="w-full space-y-4 p-4">
                  ...
                  {showAddOpenAIKeyButton && (
                    <>
                      <InputComponent
                        ...
                        optionsPlaceholder={"Globala Variabler"}
                        optionsIcon="Globe"
                ...
                {!showAllSettings && (
                  <div className="flex gap-2">
                    ...
                    >
                      {isEditingOpenAIKey ? "Uppdatera" : "Spara"}
                    </Button>
                  </div>
                )}
                  ...
                  <>
                    <div className="grid w-full items-center gap-2">
                      <span className="flex items-center text-sm">
                        ...
                        <ShadTooltip content="Om du har en ElevenLabs API-nyckel kan du välja ElevenLabs-röster.">
                          <div>
                            <IconComponent
                              name="Info"
                              strokeWidth={2}
                      ...
                      <InputComponent
                        ...
                        placeholder={getPlaceholder(
                          false,
                          "Ange din ElevenLabs API-nyckel",
                        )}
