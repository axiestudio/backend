...
export default function IOModal({
  ...
  const PlaygroundTitle = playgroundPage && flowName ? flowName : "Lekplats";
    ...
    deleteSessionFunction(
      { sessionId: session_id },
      {
        onSuccess: () => {
          ...
          setSuccessData({
            title: "Session borttagen framgångsrikt.",
          });
        },
        onError: () => {
          ...
          setErrorData({
            title: "Fel vid borttagning av session.",
          });
        },
      },
    );
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    >
                      <AxieStudioLogoColor />
                      <div className="text-sm">Byggd med Axie Studio</div>
                    </Button>
                  </div>
                )}
              </div>
