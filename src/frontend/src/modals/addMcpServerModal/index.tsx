...
export default function AddMcpServerModal({
  ...
  async function submitForm() {
    ...
    try {
      ...
      setError(e.message || "Ogiltig inmatning");
      return;
    }
    if (servers.length === 0) {
      ...
      <BaseModal.Content className="flex flex-col justify-between overflow-hidden">
              ...
              >
                ...
                <TabsContent value="STDIO">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <Label className="!text-mmd">Argument</Label>
                      <InputListComponent
                        value={stdioArgs}
                ...
                <TabsContent value="SSE">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <Label className="!text-mmd">Rubriker</Label>
                      <IOKeyPairInput
                        value={sseHeaders}
        ...
        <div className="flex justify-end gap-2 p-4">
          <Button variant="outline" size="sm" onClick={() => setOpen(false)}>
            <span className="text-mmd font-normal">Avbryt</span>
          </Button>
          <Button
            size="sm"
            onClick={submitForm}
          ...
          >
            <span className="text-mmd">
              {initialData ? "Uppdatera Server" : "Lägg till Server"}
            </span>
          </Button>
        </div>
      </BaseModal.Content>
