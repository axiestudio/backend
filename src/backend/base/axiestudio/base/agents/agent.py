...
from axiestudio.base.agents.callback import AgentAsyncHandler
from axiestudio.base.agents.events import ExceptionWithMessageError, process_agent_events
from axiestudio.base.agents.utils import data_to_messages
from axiestudio.custom.custom_component.component import Component, _get_component_toolkit
from axiestudio.field_typing import Tool
from axiestudio.inputs.inputs import InputTypes, MultilineInput
from axiestudio.io import BoolInput, HandleInput, IntInput, MessageInput
from axiestudio.logging import logger
from axiestudio.memory import delete_message
...
if TYPE_CHECKING:
    ...
    from axiestudio.schema.log import SendMessageFunctionType


DEFAULT_TOOLS_DESCRIPTION = "En hjälpsam assistent med tillgång till följande verktyg:"
...
class LCAgentComponent(Component):
    ...
    _base_inputs: list[InputTypes] = [
        ...
        BoolInput(name="verbose", display_name="Utförlig", value=True, advanced=True),
        IntInput(
            name="max_iterations",
        ...
        MultilineInput(
            ...
            info=(
                "Beskrivningen av agenten. Detta används endast i verktygsläge. "
                f"Standard är '{DEFAULT_TOOLS_DESCRIPTION}' och verktyg läggs till dynamiskt. "
                "Denna funktion är föråldrad och kommer att tas bort i framtida versioner."
            ),
            advanced=True,
    ...
    outputs = [
        ...
        Output(display_name="Svar", name="response", method="message_response"),
    ]
