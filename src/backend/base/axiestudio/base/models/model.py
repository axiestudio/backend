...
from axiestudio.inputs.inputs import BoolInput, InputTypes, MessageInput, MultilineInput
...
class LCModelComponent(Component):
    display_name: str = "Modellnamn"
    description: str = "Modellbeskrivning"
    trace_type = "llm"
    metadata = {
        "keywords": [
            "model",
    ...
    _base_inputs: list[InputTypes] = [
        MessageInput(name="input_value", display_name="Indata"),
        MultilineInput(
            name="system_message",
        ...
        BoolInput(name="stream", display_name="Ström", info=STREAM_INFO_TEXT, advanced=True),
    ]
    ...
    def get_llm(self, provider_name: str, model_info: dict[str, dict[str, str | list[InputTypes]]]) -> LanguageModel:
        ...
        try:
            ...
            with warnings.catch_warnings():
                ...
                models_module = importlib.import_module("axiestudio.components.models")
