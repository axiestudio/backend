...
from axiestudio.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from axiestudio.custom.tree_visitor import RequiredInputsVisitor
from axiestudio.exceptions.component import StreamingError
from axiestudio.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output

# Lazy import to avoid circular dependency
# from axiestudio.graph.state.model import create_state_model
# Lazy import to avoid circular dependency
# from axiestudio.graph.utils import has_chat_output
from axiestudio.helpers.custom import format_type
from axiestudio.memory import astore_message, aupdate_messages, delete_message
from axiestudio.schema.artifact import get_artifact_type, post_process_raw
from axiestudio.schema.data import Data
from axiestudio.schema.message import ErrorMessage, Message
from axiestudio.schema.properties import Source
from axiestudio.services.tracing.schema import Log
from axiestudio.template.field.base import UNDEFINED, Input, Output
from axiestudio.template.frontend_node.custom_components import ComponentFrontendNode
from axiestudio.utils.async_helpers import run_until_complete
from axiestudio.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from axiestudio.inputs.inputs import InputTypes
    from axiestudio.schema.dataframe import DataFrame
    from axiestudio.schema.log import LoggableType
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        try:
            from axiestudio.io import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from axiestudio.io"
