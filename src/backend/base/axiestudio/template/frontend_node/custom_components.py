...
DEFAULT_CUSTOM_COMPONENT_CODE = """from axiestudio.custom import CustomComponent
...
class Component(CustomComponent):
    display_name: str = "Anpassad komponent"
    description: str = "Skapa vilken anpassad komponent du vill!"
...
class CustomComponentFrontendNode(FrontendNode):
    ...
    display_name: str | None = "AnpassadKomponent"
    beta: bool = False
    legacy: bool = False
...
class ComponentFrontendNode(FrontendNode):
    _format_template: bool = False
    name: str = "Component"
    display_name: str | None = "Komponent"
    beta: bool = False
    minimized: bool = False
    legacy: bool = False
    template: Template = Template(
