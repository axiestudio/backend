...
DEFAULT_PROMPT = """
Jag vill att du ska agera som namnkonsult för nya företag.

Här är några exempel på bra företagsnamn:

- sökmotor, Google
- sociala medier, Facebook
- videodelning, YouTube

Namnet ska vara kort, catchy och lätt att komma ihåg.

Vad är ett bra namn för ett företag som tillverkar {product}?
"""

SYSTEM_PROMPT = """
Du är en hjälpsam assistent som pratar avslappnat om livet i allmänhet.
Du är en bra lyssnare och du kan prata om vad som helst.
"""
