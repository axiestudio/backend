...
class MilvusVectorStoreComponent(LCVectorStoreComponent):
    """Milvus vektorlager med sökmöjligheter."""

    display_name: str = "Milvus"
    description: str = "Milvus vektorlager med sökmöjligheter"
    name = "Milvus"
    icon = "Milvus"

    inputs = [
        StrInput(name="collection_name", display_name="Samlingnamn", value="axiestudio"),
        StrInput(name="collection_description", display_name="Samlingbeskrivning", value=""),
        StrInput(
            name="uri",
            display_name="Anslutnings-URI",
        ...
        SecretStrInput(
            ...
            display_name="Token",
            value="",
            info="Ignorera detta fält om ingen token krävs för att göra anslutning.",
        ),
