...
class PGVectorStoreComponent(LCVectorStoreComponent):
    ...
    description = "PGVector Vektorlager med sökmöjligheter"
    name = "pgvector"
    icon = "cpu"

    inputs = [
        SecretStrInput(name="pg_server_url", display_name="PostgreSQL Server-anslutningssträng", required=True),
        StrInput(name="collection_name", display_name="Tabell", required=True),
        *LCVectorStoreComponent.inputs,
        HandleInput(name="embedding", display_name="Inbäddning", input_types=["Embeddings"], required=True),
        IntInput(
