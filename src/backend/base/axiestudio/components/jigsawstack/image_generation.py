...
class JigsawStackImageGenerationComponent(Component):
    display_name = "Bildgenerering"
    description = "Generera en bild baserat på given text genom att använda AI-modeller som Flux, \
        Stable Diffusion och andra toppmodeller."
