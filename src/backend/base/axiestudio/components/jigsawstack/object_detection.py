...
class JigsawStackObjectDetectionComponent(Component):
    display_name = "Objektdetektering"
    description = "Utför objektdetektering på bilder med JigsawStacks objektdetekteringsmodell, \
        kapabel till bildgrundning, segmentering och datoranvändning."
