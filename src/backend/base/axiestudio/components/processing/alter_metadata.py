...
from axiestudio.io import HandleInput, NestedDictInput, Output, StrInput
from axiestudio.schema.data import Data
from axiestudio.schema.dataframe import DataFrame


class AlterMetadataComponent(Component):
    display_name = "Ändra metadata"
    description = "Lägger till/tar bort metadataordbok på inmatningar"
    icon = "merge"
    name = "AlterMetadata"
    legacy = True
