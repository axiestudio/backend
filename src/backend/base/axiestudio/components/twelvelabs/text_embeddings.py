...
class TwelveLabsTextEmbeddingsComponent(LCEmbeddingsModel):
    display_name = "TwelveLabs textinbäddningar"
    description = "Generera inbäddningar med TwelveLabs textinbäddningsmodeller."
    icon = "TwelveLabs"
    ...
    inputs = [
        SecretStrInput(name="api_key", display_name="TwelveLabs API-nyckel", value="TWELVELABS_API_KEY", required=True),
        DropdownInput(
            name="model",
            display_name="Modell",
            advanced=False,
