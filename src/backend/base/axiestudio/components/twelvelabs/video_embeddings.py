...
from axiestudio.io import DropdownInput, IntInput, SecretStrInput
...
class TwelveLabsVideoEmbeddingsComponent(LCEmbeddingsModel):
    display_name = "TwelveLabs videoinbäddningar"
    description = "Generera inbäddningar från videor med TwelveLabs videoinbäddningsmodeller."
    ...
    inputs = [
        ...
        IntInput(name="request_timeout", display_name="Begäran timeout", advanced=True),
    ]
