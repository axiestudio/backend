...
from axiestudio.inputs.inputs import IntInput, MessageTextInput, MultilineInput, SecretStrInput
...
class BingSearchAPIComponent(LCToolComponent):
    ...
    description = "Anropa Bing Search API."
    name = "BingSearchAPI"
    icon = "Bing"

    inputs = [
        SecretStrInput(name="bing_subscription_key", display_name="Bing-prenumerationsnyckel"),
        MultilineInput(
            name="input_value",
            display_name="Indata",
        ),
    ...
    outputs = [
        ...
        Output(display_name="Verktyg", name="tool", method="build_tool"),
    ]
