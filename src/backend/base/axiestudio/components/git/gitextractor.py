...
class GitExtractorComponent(Component):
    ...
    description = "Analyserar ett Git-repository och returnerar filinnehåll och komplett repository-information"
    icon = "GitLoader"
    ...
    inputs = [
        MessageTextInput(
            ...
            info="URL för Git-repositoryt (t.ex. https://github.com/username/repo)",
            value="",
        ),
    ]
