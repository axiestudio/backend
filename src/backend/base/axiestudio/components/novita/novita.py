...
from axiestudio.base.models.novita_constants import MODEL_NAMES
...
class NovitaModelComponent(LCModelComponent):
    ...
    description = "Genererar text med Novita AI LLM:er (OpenAI-kompatibel)."
    icon = "Novita"
    name = "NovitaModel"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        SecretStrInput(
            name="api_key",
            display_name="Novita API-nyckel",
            info="Novita API-nyckeln att använda för Novita AI-modeller.",
            advanced=False,
            value="NOVITA_API_KEY",
            real_time_refresh=True,
        ),
        SliderInput(name="temperature", display_name="Temperatur", value=0.1, range_spec=RangeSpec(min=0, max=1)),
        IntInput(
            name="seed",
            display_name="Frö",
        ...
        HandleInput(
            ...
            info="Tolken att använda för att tolka modellens utdata",
            advanced=True,
