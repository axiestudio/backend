...
from axiestudio.base.data import BaseFileComponent
from axiestudio.inputs import IntInput, NestedDictInput, StrInput
from axiestudio.inputs.inputs import FloatInput
from axiestudio.schema import Data


class DoclingRemoteComponent(BaseFileComponent):
    display_name = "Docling Serve"
    description = "Använder Docling för att bearbeta inmatningsdokument genom att ansluta till din instans av Docling Serve."
