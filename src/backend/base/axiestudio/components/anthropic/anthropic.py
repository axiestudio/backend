...
class AnthropicModelComponent(LCModelComponent):
    ...
    description = "Generera text med Anthropics Messages API och modeller."
    icon = "Anthropic"
    name = "AnthropicModel"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        SecretStrInput(
            name="api_key",
            display_name="Anthropic API-nyckel",
            info="Din Anthropic API-nyckel.",
            value=None,
            required=True,
        ...
        MessageTextInput(
            ...
            info="Endpoint för Anthropic API. Standard är 'https://api.anthropic.com' om inte angivet.",
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        try:
            ...
            msg = "langchain_anthropic är inte installerat. Vänligen installera det med `pip install langchain_anthropic`."
        ...
        try:
            ...
            msg = "Kunde inte ansluta till Anthropic API."
