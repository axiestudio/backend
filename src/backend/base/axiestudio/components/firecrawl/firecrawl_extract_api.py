...
class FirecrawlExtractApi(Component):
    ...
    description: str = "Extraherar data från en URL."
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            display_name="URL:er",
            required=True,
            info="Lista över URL:er att extrahera data från (separerade med komman eller nya rader).",
            tool_mode=True,
        ),
        MultilineInput(
            name="prompt",
            display_name="Prompt",
            required=True,
            info="Prompt för att guida extraheringsprocessen.",
            tool_mode=True,
        ),
        DataInput(
            name="schema",
            display_name="Schema",
            required=False,
            info="Schema för att definiera strukturen för extraherade data.",
        ),
        BoolInput(
            name="enable_web_search",
            display_name="Aktivera webbsökning",
            info="När det är sant kommer extraheringen att använda webbsökning för att hitta ytterligare data.",
        ),
