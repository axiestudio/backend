...
from axiestudio.io import DataInput, IntInput, MultilineInput, Output, SecretStrInput, StrInput
from axiestudio.schema.data import Data


class FirecrawlCrawlApi(Component):
    display_name: str = "Firecrawl Crawl API"
    description: str = "Crawlar en URL och returnerar resultaten."
