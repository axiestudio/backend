...
from axiestudio.io import DataInput, DropdownInput, FloatInput, IntInput, MultilineInput, Output, SecretStrInput
from axiestudio.schema.data import Data


class AssemblyAILeMUR(Component):
    display_name = "AssemblyAI LeMUR"
    description = "Tillämpa stora språkmodeller på talad data med AssemblyAI LeMUR-ramverket"
