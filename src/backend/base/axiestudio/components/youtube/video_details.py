...
from axiestudio.inputs.inputs import BoolInput, MessageTextInput, SecretStrInput
...
class YouTubeVideoDetailsComponent(Component):
    ...
    display_name: str = "YouTube-videodetaljer"
    description: str = "Hämtar detaljerad information och statistik om YouTube-videor."
    icon: str = "YouTube"
    ...
    inputs = [
        MessageTextInput(
            ...
            info="URL:en för YouTube-videon.",
            tool_mode=True,
            required=True,
        ),
        SecretStrInput(
        ...
        BoolInput(
            ...
            value=True,
            info="Inkludera videolängd, kvalitet och åldersbegränsningsinformation.",
            advanced=True,
        ),
        BoolInput(
            name="include_tags",
            display_name="Inkludera taggar",
            value=True,
            info="Inkludera videotaggar och nyckelord.",
            advanced=True,
        ),
        BoolInput(
            ...
            value=True,
            info="Inkludera video-miniatyrbild-URL:er i olika upplösningar.",
            advanced=True,
        ),
    ]
    ...
    def get_video_details(self) -> DataFrame:
        ...
        try:
            ...
            error_message = f"YouTube API-fel: {e!s}"
            if e.resp.status == self.API_FORBIDDEN:
                ...
                error_message = "Video hittades inte."
