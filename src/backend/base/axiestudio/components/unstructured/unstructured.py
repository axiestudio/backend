...
from axiestudio.inputs.inputs import DropdownInput, MessageTextInput, NestedDictInput, SecretStrInput
...
class UnstructuredComponent(BaseFileComponent):
    ...
    description = (
        "Använder Unstructured.io API för att extrahera ren text från råa källdokument. Stöder ett brett utbud av filtyper."
    )
    documentation = (
