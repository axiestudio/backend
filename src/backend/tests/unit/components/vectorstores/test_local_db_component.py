...
import pytest
from axiestudio.components.vectorstores.local_db import LocalDBComponent
from axiestudio.schema.data import Data
from axiestudio.services.cache.utils import CACHE_DIR
...
class TestLocalDBComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("axiestudio.components.vectorstores.local_db.LocalDBComponent.list_existing_collections")
