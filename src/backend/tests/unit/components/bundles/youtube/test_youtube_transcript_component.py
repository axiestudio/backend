...
import pytest
from axiestudio.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("axiestudio.components.youtube.youtube_transcripts.YoutubeLoader")
