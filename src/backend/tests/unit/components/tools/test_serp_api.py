...
from axiestudio.components.serpapi.serp import SerpComponent
...
@patch("axiestudio.components.serpapi.serp.SerpAPIWrapper")
...
def test_error_handling():
    ...
    with patch("axiestudio.components.serpapi.serp.SerpAPIWrapper") as mock_serpapi:
        mock_instance = MagicMock()
