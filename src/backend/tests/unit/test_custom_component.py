...
from axiestudio.custom import Component, CustomComponent
from axiestudio.custom.code_parser.code_parser import CodeParser, CodeSyntaxError
from axiestudio.custom.custom_component.base_component import BaseComponent, ComponentCodeNullError
...
def test_code_parser_parse_classes():
    ...
    parser = CodeParser("from axiestudio.custom import Component\n\nclass Test(Component): pass")
    tree = parser.get_tree()
    for node in ast.walk(tree):
