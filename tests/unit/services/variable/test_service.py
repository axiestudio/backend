...
import pytest
from axiestudio.services.database.models.variable.model import VariableUpdate
...
from axiestudio.services.variable.constants import CREDENTIAL_TYPE
from axiestudio.services.variable.service import DatabaseVariableService
...
async def test_initialize_user_variables__not_found_variable(service, session: AsyncSession):
    with patch("axiestudio.services.variable.service.DatabaseVariableService.create_variable") as m:
