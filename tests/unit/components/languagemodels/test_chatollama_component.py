...
from axiestudio.components.ollama.ollama import ChatOllamaComponent
...
class TestChatOllamaComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("axiestudio.components.ollama.ollama.ChatOllama")
    ...
    @pytest.mark.asyncio
    @patch("axiestudio.components.ollama.ollama.httpx.AsyncClient.post")
    @patch("axiestudio.components.ollama.ollama.httpx.AsyncClient.get")
