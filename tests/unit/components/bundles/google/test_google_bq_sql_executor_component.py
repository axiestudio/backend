...
from axiestudio.components.google.google_bq_sql_executor import BigQueryExecutorComponent
...
class TestBigQueryExecutorComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("axiestudio.components.google.google_bq_sql_executor.bigquery.Client")
