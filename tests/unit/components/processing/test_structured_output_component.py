...
from axiestudio.components.processing.structured_output import StructuredOutputComponent
from axiestudio.helpers.base_model import build_model_from_schema
from axiestudio.inputs.inputs import TableInput
...
class TestStructuredOutputComponent(ComponentTestBaseWithoutClient):
    ...
    def test_successful_structured_output_generation_with_patch_with_config(self):
        ...
        with patch("axiestudio.components.processing.structured_output.get_chat_result", mock_get_chat_result):
    ...
    @patch("axiestudio.components.processing.structured_output.get_chat_result")
    ...
    def test_build_structured_output_fails_when_base_returns_non_list(self):
        ...
        with (
            patch("axiestudio.components.processing.structured_output.get_chat_result", mock_get_chat_result),
