...
class CleanlabRAGEvaluator(Component):
    ...
    display_name = "Cleanlab RAG-utvärderare"
    description = "Utvärdera kontext, fråga och svar från en RAG-pipeline med Cleanlab och ger förtroendemått."
    icon = "Cleanlab"
    ...
    inputs = [
        ...
        DropdownInput(
            name="model",
            display_name="Cleanlab-utvärderingsmodell",
            options=[
                "gpt-4.1",
                "gpt-4.1-mini",
                "gpt-4.1-nano",
