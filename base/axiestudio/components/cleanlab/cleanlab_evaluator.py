...
class CleanlabEvaluator(Component):
    ...
    display_name = "Cleanlab-utvärderare"
    description = "Utvärdera alla LLM-svar med Cleanlab och ger förtroendepoäng och förklaring."
    icon = "Cleanlab"
    ...
    inputs = [
        MessageTextInput(
            ...
            info="Systemnivåinstruktioner som läggs till före användarfrågan.",
            value="",
        ),
        MessageTextInput(
            name="prompt",
            display_name="Prompt",
            info="Användarens fråga till modellen.",
            required=True,
        ),
        MessageTextInput(
            name="response",
        ...
        SecretStrInput(
            name="api_key",
            display_name="Cleanlab API-nyckel",
            info="Din Cleanlab API-nyckel.",
            required=True,
        ),
        DropdownInput(
            name="model",
