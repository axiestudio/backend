...
class NotionPageUpdate(LCToolComponent):
    display_name: str = "Uppdatera sidegenskap"
    description: str = "Uppdatera egenskaperna för en Notion-sida."
    ...
    inputs = [
        StrInput(
            name="page_id",
            display_name="Sid-ID",
            info="ID:t för Notion-sidan att uppdatera.",
        ),
        MultilineInput(
            name="properties",
            display_name="Egenskaper",
            info="Egenskaperna att uppdatera på sidan (som en JSON-sträng eller en ordbok).",
        ),
        SecretStrInput(
            name="notion_secret",
