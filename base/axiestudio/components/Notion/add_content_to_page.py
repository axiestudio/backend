...
class AddContentToPage(LCToolComponent):
    display_name: str = "Lägg till innehåll på sida"
    description: str = "Konvertera markdown-text till Notion-block och lägg till dem på en Notion-sida."
    ...
    inputs = [
        MultilineInput(
            ...
            info="Markdown-texten att konvertera till Notion-block.",
        ),
        StrInput(
            name="block_id",
            display_name="Sid-/Block-ID",
            info="ID:t för sidan/blocket att lägga till innehållet.",
        ),
        SecretStrInput(
            name="notion_secret",
