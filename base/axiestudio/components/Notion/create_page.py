...
class NotionPageCreator(LCToolComponent):
    display_name: str = "Skapa sida"
    description: str = "En komponent för att skapa Notion-sidor."
    documentation: str = "https://docs.axiestudio.se/integrations/notion/page-create"
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            display_name="Egenskaper (JSON)",
            info="Egenskaperna för den nya sidan som en JSON-sträng.",
        ),
    ]
