...
class NotionSearch(LCToolComponent):
    display_name: str = "Sök"
    description: str = "Söker alla sidor och databaser som har delats med en integration."
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Texten som API:et jämför sid- och databastitlar mot.",
        ),
        DropdownInput(
            name="filter_value",
