...
class GmailLoaderComponent(Component):
    display_name = "Gmail-laddare"
    description = "Laddar e-postmeddelanden från Gmail med angivna autentiseringsuppgifter."
    icon = "Google"
    legacy: bool = True
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="Kommaseparerad lista över etikett-ID:n för att filtrera e-postmeddelanden.",
            required=True,
        ...
        MessageTextInput(
            ...
            info="Maximalt antal e-postmeddelanden att ladda.",
            required=True,
            value="10",
        ),
    ]
