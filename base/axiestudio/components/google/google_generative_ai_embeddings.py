...
MIN_DIMENSION_ERROR = "Utdatadimensionalitet måste vara minst 1"
MAX_DIMENSION_ERROR = (
    "Utdatadimensionalitet kan inte överstiga 768. Googles inbäddningsmodeller stöder endast dimensioner upp till 768."
)
MAX_DIMENSION = 768
MIN_DIMENSION = 1
