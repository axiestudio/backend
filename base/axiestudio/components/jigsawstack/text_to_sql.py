...
from axiestudio.io import MessageTextInput, Output, QueryInput, SecretStrInput, StrInput
from axiestudio.schema.data import Data


class JigsawStackTextToSQLComponent(Component):
    display_name = "Text till SQL"
    description = "Konvertera naturligt språk till SQL-frågor med JigsawStack AI"
    ...
    def generate_sql(self) -> Data:
        ...
        try:
            schema_error = "Antingen 'sql_schema' eller 'file_store_key' måste anges"
