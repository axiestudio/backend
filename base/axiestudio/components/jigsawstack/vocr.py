...
from axiestudio.io import IntInput, MessageTextInput, Output, SecretStrInput, StrInput
from axiestudio.schema.data import Data


class JigsawStackVOCRComponent(Component):
    display_name = "VOCR"
    description = "Extrahera data från vilken dokumenttyp som helst i en konsekvent struktur med finjusterade \
        vLLM:er för högsta noggrannhet"
