...
class JigsawStackFileReadComponent(Component):
    display_name = "Filläsning"
    description = "Läs vilken tidigare uppladdad fil som helst sömlöst från \
        JigsawStack fillagring och använd den i dina AI-applikationer."
    ...
    inputs = [
        ...
        StrInput(
            name="key",
            display_name="Nyckel",
            info="Nyckeln som används för att hämta filen från JigsawStack fillagring.",
            required=True,
            tool_mode=True,
        ),
    ]
    ...
    outputs = [
        Output(display_name="Filsökväg", name="file_path", method="read_and_save_file"),
    ]
