...
class ListHomeAssistantStates(LCToolComponent):
    ...
    description: str = (
        "Hämta tillstånd från Home Assistant. "
        "Agenten behöver endast specificera 'filter_domain' (valfritt). "
        "Token och base_url exponeras inte för agenten."
    )
    ...
    inputs = [
        SecretStrInput(
            ...
            info="Home Assistant långlivad åtkomsttoken",
            required=True,
        ),
        StrInput(
            name="base_url",
