...
from axiestudio.inputs.inputs import BoolInput, DropdownInput, HandleInput, MultilineInput


class RetrievalQAComponent(LCChainComponent):
    display_name = "Retrieval QA"
    description = "Kedja för fråga-svar som frågar källor från en retriever."
    name = "RetrievalQA"
    legacy: bool = True
    icon = "LangChain"
    inputs = [
        ...
        DropdownInput(
            name="chain_type",
            display_name="Kedjetyp",
            info="Kedjetyp att använda.",
        ...
        BoolInput(
            ...
            display_name="Returnera källdokument",
            value=False,
        ),
    ]
