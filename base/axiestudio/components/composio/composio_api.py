...
class ComposioAPIComponent(LCToolComponent):
    display_name: str = "Composio-verktyg"
    description: str = "Använd Composio-verktygsuppsättning för att köra åtgärder med din agent"
    name = "ComposioAPI"
    icon = "Composio"
    ...
    inputs = [
        ...
        MessageTextInput(name="entity_id", display_name="Entitets-ID", value="default", advanced=True),
        SecretStrInput(
            name="api_key",
            display_name="Composio API-nyckel",
            required=True,
            info="Se https://docs.composio.dev/faq/api_key/api_key",
            real_time_refresh=True,
        ),
        ConnectionInput(
            name="tool_name",
            display_name="Verktygsnamn",
            placeholder="Välj ett verktyg...",
            button_metadata={"icon": "unplug", "variant": "destructive"},
            options=[],
            search_category=[],
            value="",
            connection_link="",
            info="Namnet på verktyget att använda",
            real_time_refresh=True,
        ),
        SortableListInput(
            name="actions",
