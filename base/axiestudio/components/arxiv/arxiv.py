...
from axiestudio.io import DropdownInput, IntInput, MessageTextInput, Output
...
class ArXivComponent(Component):
    display_name = "arXiv"
    description = "Sök och hämta artiklar från arXiv.org"
    icon = "arXiv"
    ...
    inputs = [
        MessageTextInput(
            ...
            info="Sökfrågan för arXiv-artiklar (t.ex. 'quantum computing')",
            tool_mode=True,
        ),
        DropdownInput(
            name="search_type",
            display_name="Sökfält",
            info="Fältet att söka i",
        ...
        IntInput(
            ...
            info="Maximalt antal resultat att returnera",
            value=10,
        ),
    ]
