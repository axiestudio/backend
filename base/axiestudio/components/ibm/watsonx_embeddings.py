...
from axiestudio.io import BoolInput, DropdownInput, IntInput, SecretStrInput, StrInput
from axiestudio.schema.dotdict import dotdict


class WatsonxEmbeddingsComponent(LCEmbeddingsModel):
    display_name = "IBM watsonx.ai Inbäddningar"
    description = "Generera inbäddningar med IBM watsonx.ai-modeller."
    icon = "WatsonxAI"
    ...
    inputs = [
        ...
        IntInput(
            ...
            display_name="Trunkera indata-tokens",
            advanced=True,
            value=200,
        ),
        BoolInput(
            name="input_text",
            display_name="Inkludera originaltext i utdata",
            value=True,
            advanced=True,
        ),
    ]
