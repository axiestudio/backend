...
class NotDiamondComponent(Component):
    ...
    description = "Anropa rätt modell vid rätt tidpunkt med världens mest kraftfulla AI-modellrouter."
    ...
    inputs = [
        MessageInput(name="input_value", display_name="Indata", required=True),
        MessageTextInput(
            name="system_message",
            display_name="Systemmeddelande",
            info="Systemmeddelande att skicka till modellen.",
            advanced=False,
        ),
        HandleInput(
            name="models",
            ...
            required=True,
            is_list=True,
            info="Länka modellerna du vill välja mellan.",
        ),
        SecretStrInput(
            name="api_key",
            display_name="Not Diamond API-nyckel",
            info="Not Diamond API-nyckeln att använda för dirigering.",
            advanced=False,
        ...
        StrInput(
            name="preference_id",
            display_name="Preferens-ID",
            info="ID:t för routerpreferensen som konfigurerades via instrumentpanelen.",
            advanced=False,
        ),
        DropdownInput(
            name="tradeoff",
            display_name="Avvägning",
            info="Avvägningen mellan kostnad och latens för routern att bestämma den bästa LLM:en för en given fråga.",
            advanced=False,
        ...
        BoolInput(
            name="hash_content",
            display_name="Hasha innehåll",
            info="Om innehållet ska hashas innan det skickas till NotDiamond API.",
            advanced=False,
            value=False,
        ),
    ]
    ...
    outputs = [
        Output(display_name="Utdata", name="output", method="model_select"),
        Output(
            display_name="Vald modell",
            name="selected_model",
