...
from axiestudio.inputs.inputs import DropdownInput, FileInput, HandleInput, MultilineInput
...
class AstraAssistantManager(ComponentWithCache):
    display_name = "Astra-assistentagent"
    name = "Astra-assistentagent"
    description = "Hanterar assistentinteraktioner"
    icon = "AstraDB"
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            info="Instruktioner för assistenten, tänk på dessa som systemprompt.",
        ),
        HandleInput(
            name="input_tools",
        ...
        # ),
        MultilineInput(
            name="user_message", display_name="Användarmeddelande", info="Användarmeddelande att skicka till körningen.", tool_mode=True
        ),
        FileInput(
            name="file",
            display_name="Fil(er) för hämtning",
            list=True,
