...
class XAIModelComponent(LCModelComponent):
    display_name = "xAI"
    description = "Genererar text med xAI-modeller som Grok."
    icon = "xAI"
    name = "xAIModel"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        DropdownInput(
            ...
            refresh_button=True,
            combobox=True,
            info="xAI-modellen att använda",
        ),
        MessageTextInput(
            name="base_url",
            display_name="xAI API-bas",
            advanced=True,
            info="Bas-URL:en för xAI API. Standard är https://api.x.ai/v1",
            value="https://api.x.ai/v1",
        ),
        SecretStrInput(
            name="api_key",
            display_name="xAI API-nyckel",
            info="xAI API-nyckeln att använda för modellen.",
            advanced=False,
            value="XAI_API_KEY",
            required=True,
        ),
