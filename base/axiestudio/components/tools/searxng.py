...
from axiestudio.inputs.inputs import DropdownInput, IntInput, MessageTextInput, MultiselectInput
...
class SearXNGToolComponent(LCToolComponent):
    search_headers: dict = {}
    display_name = "SearXNG-sökning"
    description = "En komponent som söker efter verktyg med SearXNG."
    name = "SearXNGTool"
    legacy: bool = True
    ...
    outputs = [
        Output(display_name="Verktyg", name="result_tool", method="build_tool"),
    ]
    ...
    def update_build_config(self, build_config: dotdict, field_value: Any, field_name: str | None = None) -> dotdict:
        ...
        try:
            ...
            build_config["categories"]["options"] = ["Misslyckades att tolka", str(e)]
        return build_config
    ...
    def build_tool(self) -> Tool:
        ...
        schema_fields = {
            ...
            "categories": (
                list[str],
                Field(default=[], description="Kategorierna att söka i."),
            ),
        }
        ...
        return StructuredTool.from_function(
            ...
            description="Ett verktyg som söker efter verktyg med SearXNG.\nTillgängliga kategorier är: "
