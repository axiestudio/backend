...
from axiestudio.inputs.inputs import DictInput, IntInput, MessageTextInput, MultilineInput, SecretStrInput
from axiestudio.schema.data import Data


class SearchAPIComponent(LCToolComponent):
    display_name: str = "Search API [FÖRÅLDRAD]"
    description: str = "Anropa searchapi.io API med resultatbegränsning"
    name = "SearchAPI"
    ...
    inputs = [
        MessageTextInput(name="engine", display_name="Motor", value="google"),
    ...
    class SearchAPISchema(BaseModel):
        ...
        params: dict[str, Any] = Field(default_factory=dict, description="Ytterligare sökparametrar")
    ...
    def build_tool(self) -> Tool:
        ...
        tool = StructuredTool.from_function(
            name="search_api",
            description="Sök efter senaste resultat med searchapi.io med resultatbegränsning",
            func=search_func,
            args_schema=self.SearchAPISchema,
        )

        self.status = f"Search API-verktyg skapat med motor: {self.engine}"
        return tool
