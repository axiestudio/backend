...
from axiestudio.inputs.inputs import BoolInput, DropdownInput, FloatInput, IntInput, MessageTextInput, SecretStrInput
from axiestudio.schema.data import Data


class NvidiaIngestComponent(BaseFileComponent):
    display_name = "NVIDIA Retriever-extraktion"
    description = "Multimodal dataextraktion från dokument med NVIDIA:s NeMo API."
    ...
    inputs = [
        *BaseFileComponent._base_inputs,
        MessageTextInput(
            ...
            info="URL:en för NVIDIA NeMo Retriever Extraction API.",
            required=True,
        ),
        SecretStrInput(
            name="api_key",
