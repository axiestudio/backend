...
class TavilySearchComponent(Component):
    ...
    description = """**Tavily Search** är en sökmotor optimerad för LLM:er och RAG, \
        inriktad på effektiva, snabba och beständiga sökresultat."""
    icon = "TavilyIcon"
    ...
    inputs = [
        ...
        IntInput(
            ...
            info=("Antalet innehållsdelar att hämta från varje källa (1-3). Fungerar endast med avancerad sökning."),
            value=3,
            advanced=True,
        ),
        DropdownInput(
