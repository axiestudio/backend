...
from axiestudio.inputs import DataInput, DropdownInput, SecretStrInput, StrInput
...
class PegasusIndexVideo(Component):
    ...
    display_name = "TwelveLabs Pegasus indexera video"
    description = "Indexera videor med TwelveLabs och lägg till video_id till metadata."
    icon = "TwelveLabs"
    ...
    inputs = [
        DataInput(
            ...
            info="Videodataobjekt (från VideoFile eller SplitVideo)",
            is_list=True,
            required=True,
        ),
        SecretStrInput(
        ...
        StrInput(
            ...
            info="Namnet på indexet att använda. Om indexet inte finns kommer det att skapas.",
            required=False,
        ),
        StrInput(
            name="index_id",
    ...
    outputs = [
        Output(
            display_name="Indexerad data", name="indexed_data", method="index_videos", output_types=["Data"], is_list=True
        ),
    ]
