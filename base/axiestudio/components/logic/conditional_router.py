...
from axiestudio.io import BoolInput, DropdownInput, IntInput, MessageInput, MessageTextInput, Output
from axiestudio.schema.message import Message


class ConditionalRouterComponent(Component):
    display_name = "If-Else"
    description = "Dirigerar ett inmatningsmeddelande till motsvarande utmatning baserat på textjämförelse."
    documentation: str = "https://docs.axiestudio.org/components-logic#conditional-router-if-else-component"
    icon = "split"
    ...
    inputs = [
        MessageTextInput(
            ...
            info="Den primära textinmatningen för operationen.",
            required=True,
        ),
        DropdownInput(
            name="operator",
            ...
            info="Operatorn att använda för att jämföra texterna.",
            value="equals",
            real_time_refresh=True,
        ),
        MessageTextInput(
            name="match_text",
            display_name="Matchningstext",
            info="Textinmatningen att jämföra mot.",
            required=True,
        ),
        BoolInput(
            name="case_sensitive",
