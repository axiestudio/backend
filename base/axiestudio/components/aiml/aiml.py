...
from axiestudio.base.models.aiml_constants import AimlModels
...
class AIMLModelComponent(LCModelComponent):
    ...
    description = "Genererar text med AI/ML API LLM:er."
    icon = "AIML"
    name = "AIMLModel"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        DictInput(name="model_kwargs", display_name="Modellkwargs", advanced=True),
        DropdownInput(
            name="model_name",
