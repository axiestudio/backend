...
from axiestudio.inputs import DictInput, DropdownInput, MessageTextInput, SortableListInput
...
class DataOperationsComponent(Component):
    display_name = "Dataoperationer"
    description = "Utför olika operationer på ett Data-objekt."
    documentation: str = "https://docs.axiestudio.se/components-processing#data-operations"
    icon = "file-json"
    name = "DataOperations"
    ...
    inputs = [
        DataInput(name="data", display_name="Data", info="Data-objekt att filtrera.", required=True, is_list=True),
        SortableListInput(
            name="operations",
            display_name="Operationer",
            placeholder="Välj operation",
            info="Lista med operationer att utföra på data.",
            options=[
        ...
        MessageTextInput(
            ...
            display_name="Välj nycklar", 
            info="Lista med nycklar att välja från data.",
            show=False,
            is_list=True,
        ),
        ...
        MessageTextInput(
            name="filter_key",
            display_name="Filtrera nyckel",
            info="Nyckel att filtrera efter.",
            is_list=True,
            show=False,
        ),
        DropdownInput(
            name="operator",
            display_name="Jämförelseoperator",
            options=["equals", "not equals", "contains", "starts with", "ends with"],
            info="Operatorn att använda för att jämföra värden.",
            value="equals",
            advanced=False,
            show=False,
        ),
        DictInput(
            name="filter_values",
            display_name="Filtrera värden",
            info="Lista med värden att filtrera efter.",
            show=False,
            is_list=True,
        ),
        ...
        DictInput(
            ...
            display_name="Lägg till eller uppdatera",
            info="Data att lägga till eller uppdatera med.",
            show=False,
            value={"key": "value"},
            is_list=True,
        ),
        ...
        MessageTextInput(
            ...
            display_name="Ta bort nycklar",
            info="Lista med nycklar att ta bort från data.",
            show=False,
            is_list=True,
        ),
        # rename keys inputs
        DictInput(
            ...
            display_name="Byt namn på nycklar",
            info="Lista med nycklar att byta namn på.",
            show=False,
            is_list=True,
