...
class AgentComponent(ToolCallingAgentComponent):
    ...
    documentation: str = "https://docs.axiestudio.se/agents"
    icon = "bot"
    beta = False
    name = "Agent"
    ...
    inputs = [
        ...
        *openai_inputs_filtered,
        MultilineInput(
            ...
            info="Systemprompt: Initiala instruktioner och kontext för att vägleda agentens beteende.",
        ...
        *LCToolsAgentComponent._base_inputs,
        ...
        BoolInput(
            ...
            advanced=True,
            info="Om sant kommer det att lägga till ett verktyg till agenten som returnerar aktuellt datum.",
            value=True,
        ),
    ]
    outputs = [
