...
class DoclingInlineComponent(BaseFileComponent):
    ...
    description = "Använder Docling för att bearbeta inmatningsdokument genom att köra Docling-modeller lokalt."
    ...
    inputs = [
        *BaseFileComponent._base_inputs,
        DropdownInput(
            ...
            info="Docling-pipeline att använda",
