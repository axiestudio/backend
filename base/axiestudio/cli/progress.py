...
def create_axiestudio_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Axie Studio initialization steps."""
...
def create_axiestudio_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Axie Studio shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
