...
from axiestudio.services.deps import get_chat_service

health_check_router = APIRouter(tags=["Hälsokontroll"])


class HealthResponse(BaseModel):
    status: str = "ej ok"
    chat: str = "fel kontrollera serverloggarna"
    db: str = "fel kontrollera serverloggarna"
    """
    ...
    def has_error(self) -> bool:
        return any(v.startswith("fel") for v in self.model_dump().values())
